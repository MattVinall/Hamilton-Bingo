export const Intro = () => {
    ...
    return (
        <section className="h-[85vh] flex flex-col justify-center items-center">
            <iframe className="mb-16" width="560" height="315" src="https://www.youtube.com/embed/1w6-BLOt2os?si=WhLH66sXBe4niVyl" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen loading="lazy"></iframe>            
