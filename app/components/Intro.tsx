export const Intro = () => {
    ...
    return (
        <section id="intro" className="md:min-h-[85vh] flex flex-col justify-center items-center">
            ...
            <div className="container mx-auto ">
                ...
                <div className="container mx-auto my-12 text-center">
                    ...
                    <a href="#print" onClick={handleJumpToPrint} className="mt-8 ml-8 text-white font-bold py-4 px-6 rounded-full">Print Bingo Board</a>
                </div>
            </div>
        </section>
    );
